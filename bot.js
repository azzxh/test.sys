...
client.on('ready', function(){
    ...
    setInterval(function (){
        ...
        if( i == (setGame.https://discord.gg/k4BmaQ)-1 ){
            j = -1;
        }
        i = i+j;
        client.user.setGame(setGame[i],`https://www.youtube.com/channel/UCT_sitVo0mxinH_DCxNTXxQ/videos`);
    }, ms);
...
${prefix}حضر/ عدد الاشخاص المبندة 
